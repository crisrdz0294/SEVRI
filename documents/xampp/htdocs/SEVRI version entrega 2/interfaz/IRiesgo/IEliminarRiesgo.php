...
<body>
	...
	<div class="general">
		<div class="formulario">
			<form id="IEliminarRiesgo" method="Post" role="form">
  						...
  						<table border="1">
							...
							foreach ($lista as $riesgo){
					            echo "<tr>					        
								        ...
								        <td><input class=\"btn btn-default\" type=\"submit\" value=\"Eliminar\" onclick=\"eliminarRiesgo('".$riesgo->getId()."')\"/></td>
								    </tr>";
								}
							?>
  						</table>
